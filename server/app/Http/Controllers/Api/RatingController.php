...
class RatingController extends Controller
{
    ...
    {
        //get books
        $booksrating = Book::join('ratings', 'books.idbuku', '=', 'ratings.book_id')
            ->join('comments', 'books.idbuku', '=', 'comments.book_id')
            ->get();
